...
INSERT INTO `guestbook` (`wp_id`, `wp_uniqid`, `wp_active`, `wp_username`, `wp_password`, `wp_question`, `wp_answer`, `wp_email`, `wp_qq`, `wp_sex`, `wp_face`, `wp_url`, `wp_reg_time`, `wp_last_time`, `wp_last_ip`) VALUES
